...
export type GetApiKeysAggregateType<T extends ApiKeysAggregateArgs> = {
    [P in keyof T & keyof AggregateApiKeys]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateApiKeys[P]> : Prisma.GetScalarType<T[P], AggregateApiKeys[P]>;
};
...
type GetApiKeysGroupByPayload<T extends apiKeysGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ApiKeysGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ApiKeysGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ApiKeysGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ApiKeysGroupByOutputType[P]>;
}>>;
...
export type apiKeysCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<apiKeysFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface apiKeysDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['apiKeys'];
        meta: {
            name: 'apiKeys';
        };
    };
     ...
     * })
    **/
    count<T extends apiKeysCountArgs>(args?: Prisma.Subset<T, apiKeysCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ApiKeysCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends apiKeysGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, apiKeysGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetApiKeysGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
