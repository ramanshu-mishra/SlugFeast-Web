...
// @ts-nocheck 
/*
 * This file exports the `blockTimeStamps` model and its related types.
 *
...
export type GetBlockTimeStampsAggregateType<T extends BlockTimeStampsAggregateArgs> = {
      [P in keyof T & keyof AggregateBlockTimeStamps]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBlockTimeStamps[P]>
    : Prisma.GetScalarType<T[P], AggregateBlockTimeStamps[P]>
}
...
type GetBlockTimeStampsGroupByPayload<T extends blockTimeStampsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BlockTimeStampsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BlockTimeStampsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BlockTimeStampsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BlockTimeStampsGroupByOutputType[P]>
      }
    >
  >
...
export type blockTimeStampsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<blockTimeStampsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface blockTimeStampsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['blockTimeStamps'], meta: { name: 'blockTimeStamps' } }
  /**
   ...
   * })
  **/
  count<T extends blockTimeStampsCountArgs>(
    args?: Prisma.Subset<T, blockTimeStampsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BlockTimeStampsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends blockTimeStampsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, blockTimeStampsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBlockTimeStampsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
